                ...
                <div className='min-h-screen flex items-center justify-center bg-gray-50'>
                    <div className='text-center max-w-md'>
                        ...
                        <p className='text-gray-600 mb-4'>
                            Ticket dengan ID tersebut tidak ditemukan.
                        </p>
                        <button
                            onClick={() => router.push('/agent/dashboard')}
                            className='bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700'
                            ...
                            <div className='bg-white rounded-lg shadow-md p-6 sticky top-6'>
                                ...
                                <div className='space-y-4'>
                                    ...
                                    <div>
                                        ...
                                        <div className='mt-1'>
                                            <span
                                                className={`inline-block px-3 py-1 rounded-full text-xs font-medium border ${getCategoryColor(ticket.category)}`}
                                            >
                                                {ticket.category}
                                            </span>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className='mt-1'>
                                            <span
                                                className={`inline-block px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(ticket.status)}`}
                                            >
                                                {ticket.status}
                                            </span>
                                        </div>
                        ...
                        <div className='lg:col-span-2'>
                            <div className='bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-[calc(100vh-200px)]'>
                                ...
                                <div className='bg-gray-50 border-b border-gray-200 px-6 py-4'>
                                    ...
                                    <p className='text-sm text-gray-600'>
                                        Messages are auto-refreshing every 10
                                        seconds
                                    </p>
                                </div>
                                    ...
                                    {messages.length === 0 ? (
                                        ...
                                        messages.map((msg, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div
                                                        className={`max-w-[70%] ${isAgent ? 'order-2' : 'order-1'}`}
                                                    >
                                                        <div
