...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push('/customer'); // Redirect setelah register
    } catch (err) {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      router.push('/customer'); // Redirect setelah sign up
    } catch (err) {
      setError(err.message || 'Daftar dengan Google gagal. Silakan coba lagi.');
    } finally {
      setLoading(false);
    }
  };
